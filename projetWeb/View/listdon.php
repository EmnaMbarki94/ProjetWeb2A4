...
<head>
    ...
    <!-- base:css -->
    <link rel="stylesheet" href="back2/template/vendors/typicons/typicons.css">
    <link rel="stylesheet" href="back2/emplateB/template/vendors/css/vendor.bundle.base.css">
    <!-- endinject -->
    <!-- plugin css for this page -->
    <!-- End plugin css for this page -->
    <!-- inject:css -->
    <link rel="stylesheet" href="back2//template/css/vertical-layout-light/style.css">
    <!-- endinject -->
    <link rel="shortcut icon" href="back2//template/images/favicon.png" />
     <style>
        body {
...
<!--<center>
    ...
    <h2>
        <a href="addDon.php">Add Donation</a>
    </h2>
</center>-->
<table border="1" align="center" width="70%">
    ...
    ?>
        <tr>
            <td><?= $donation['id_dons']; ?></td>
            <td><?= $donation['destination']; ?></td>
            <td><?= $donation['nom_donneur']; ?></td>
            <td><?= $donation['type']; ?></td>
            <td align="center">
                <form method="POST" action="updatedon.php">
                    <input type="submit" name="update" value="Update">
                    <input type="hidden" value=<?= $donation['id_dons']; ?> name="idDonation">
                </form>
            </td>
            <td>
                <a href="delete_Don.php?id=<?= $donation['id_dons']; ?>">Delete</a>
            </td>
        </tr>
    <?php
    }
