...
$l = new LigneCommandeC();
$tab = $l->listLigneCommande();

  if(isset($_GET['id']))
  {
    $id =$_GET['id'];
    $list =$l->listLigneCommandeByIdC($id);
  }
  else {
    $list = $tab; // Afficher tous les médicaments si aucun ID spécifié
}
...
<div class="container-scroller">
  ...
  <table border="1" align="center" width="80%">
    ...
    ?>
        ...
        <tr>
            <td><?= $Lignecommande['idClient']; ?></td>
            <td><?= $Lignecommande['id']; ?></td>
            <td><?= $Lignecommande['Nom']; ?></td>
            <td><?= $Lignecommande['idM']; ?></td>
            <td><?= $Lignecommande['Quantite']; ?></td>
            <td><?= $Lignecommande['total']; ?></td>
            <td align="center">
                <a href="deleteCommande.php?id=<?php echo $Lignecommande['id']; ?>">Delete</a>
            </td>
        </tr>
