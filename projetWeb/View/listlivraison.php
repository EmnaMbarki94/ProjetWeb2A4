...
<th>Delete</th>
    ...
    ?>
        <tr>
            <td><?= $livraison['id_liv']; ?></td>
            <td><?= $livraison['nom']; ?></td>
            <td><?= $livraison['destination']; ?></td>
            <td><?= $livraison['numero_tele']; ?></td>
            <td><?= $livraison['Etat_livraison']; ?></td>
            <td align="center">
                <form method="POST" action="updatelivraison.php">
                
                    <input type="submit" name="update" value="Update">
                    <input type="hidden" value=<?= $livraison['id_liv']; ?> name="idLivraison">
                </form>
            </td>
            <td>
                <a href="delete_Livraison.php?id=<?= $livraison['id_liv']; ?>">Delete</a>
            </td>
        </tr>
    <?php
    }
