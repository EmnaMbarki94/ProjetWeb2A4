        ...
        <form id="formulaireInscription" action="" method="POST" onsubmit="return validerForm();" >
            ...
            <div class="input-box">
                <div class="input-field">
                    <input type="text" id="nomPh" name="nomPh" placeholder="Name" required minlength="2" maxlength="20">
                    <span id="erreurNom" class="error"></span><br><br>
                    <i class='bx bxs-user' ></i>
                </div>
                <div class="input-field">
                    <input type="text" id="adressePh" name="adressePh" placeholder="Address" required minlength="2" maxlength="20">
                    <i class='bx bxs-user' ></i>
                </div>
            </div>
            <div class="input-box">
                <div class="input-field">
                    <input type="number" id="numPh" name="numPh" placeholder="Contact number">
