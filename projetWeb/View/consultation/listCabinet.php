  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      <div class="form-inline">
          <label for="search" class="font_weight-bold lead text-dark ">rechercher le cabinet: </label>
         <input type="text"  name="search" id="search" class="form_control form_control-lg rounded-0 border-primary">
         <input type="submit" value="rechercher" name="search"style="background-color: #75b239; color: #fff;">
          </div>
...
<table border="1" align="center" width="70%"id=result-container>
    <tr>
        <th>Id cabinet</th>
    ...
    ?>
        ...
        <tr>
            ...
            <td align="center">
                <form method="POST" action="updateCabinet.php">
                    <input type="submit" name="update" value="Update">
                    <input type="hidden" value=<?PHP echo $cabinet['id_cabinet']; ?> name="id_cabinet">
                </form>
            </td>
            <td>
                <a href="deleteCabinet.php?id=<?php echo $cabinet['id_cabinet']; ?>">Delete</a>
            </td>
        </tr>
    <?php
    }
...
$(document).ready(function () {
  $("#search").keyup(function(){
    ...
    // Utilisation d'AJAX pour effectuer la recherche
    $.ajax({
        method: 'POST',
        url: 'rechercheCA.php',
        data: { query: search },
