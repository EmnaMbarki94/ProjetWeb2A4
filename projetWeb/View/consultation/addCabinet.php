...
include 'C:/xampp/htdocs/gestionComptes/Model/cabinet.php';
...
<head>
    ...
    form {
        max-width: 600px;
        margin: 20px 400px auto; /* Ajout pour centrer le formulaire */
        padding: 30px;
...
<div class="container-scroller">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="View/listClients.php">Liste des clients </a></li>
                <li class="nav-item"> <a class="nav-link" href="View/listPharmacies.php">Liste des pharmacies </a></li>
              </ul>
            </div>
          <li class="nav-item">
    ...
    <a href="listCabinet.php">Back to list </a>
    <hr>
    ...
    <form action="" method="POST"onsubmit="return validateForm();">
        <table>
            ...
            <tr>
                <td><label for="adresse_cabinet">Adresse du cabinet  :</label></td>
                <td>
            ...
            <tr>
                <td><label for="specialite">Specialité  :</label></td>
                <td>
            ...
            <td>
            <input type="submit" value="Ajouter cabinet" style="background-color: #75b239; color: #fff;">
            </td>
            <td>
                <input type="reset" value="Reset"style="background-color: #75b239; color: #fff;">
            </td>
        </table>

    </form>
    </center>
    <script src="add_cabinet.js"></script>
