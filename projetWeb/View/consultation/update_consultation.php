...
include 'C:/xampp/htdocs/gestionComptes/Model/consultation.php';
$error = "";
        ...
        <form action="" method="POST">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="adresse_cabinet" name="adresse_cabinet" value="<?php echo $consultation['adresse_cabinet'] ?>" readonly />
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span id="erreurGrade" style="color: red"></span>
                    </td>
                </tr>
