...
{
  if(isset($_POST['id_cabinet'])&& isset($_POST['search']))
  {
    $id_cabinet =$_POST['id_cabinet'];
    $list =$c->afficherConsultation($id_cabinet);
  }
}*/
...
<div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      <div class="form-inline">
          <label for="search" class="font_weight-bold lead text-dark ">rechercher la consultation: </label>
