  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      <div class="form-inline">
          <label for="search" class="font_weight-bold lead text-dark ">Search office: </label>
         <input type="text"  name="search" id="search" class="form_control form_control-lg rounded-0 border-primary">
         <input type="submit" value="search" name="search"style="background-color: #75b239; color: #fff;">
          </div>
