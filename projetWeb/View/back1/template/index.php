          ...
          <div class="row">
            ...
            <div>
              ...
              <table>
                ...
                include_once $absolutePath . "/projet/controller/BlogC.php"; // Assuming you have a BlogC class
                $c = new BlogC();
                $tab = $c->listBlogs();
                ...
                foreach ($tab as $blog) {
                  ...
                  <tr>
                    ...
                    <td>
                      <a class="button" href="../../../views/deleteBlog.php?id=<?php echo $blog['id']; ?>">Delete</a>
                    </td>
                  </tr>
                  <?php
                }
              ...
              include_once $absolutePath . "/projet/controller/CommentC.php";
