...
<body>
  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="d-flex align-items-center justify-content-between">
          ...
          <div class="main-nav d-none d-lg-block">
            <nav class="site-navigation text-right text-md-center" role="navigation">
              <ul class="site-menu js-clone-nav d-none d-lg-block">
                ...
                <li><a href="templateF/shop.html">Store</a></li>
                ...
                <li><a href="templateF/about.html">About</a></li>
                <li><a href="templateF/contact.html">Contact</a></li>
                <li class="dropdown">
          ...
          <div class="icons">
            ...
            <a href="templateF/cart.html" class="icons-btn d-inline-block bag">
    ...
    <div class="owl-carousel owl-single px-0">
      <div class="site-blocks-cover overlay" style="background-image: url('templateF/images/hero_bg.jpg');">
        <div class="container">
          <div class="row">
            <div class="col-lg-12 mx-auto align-self-center">
              <div class="site-block-cover-content text-center">
                <h1 class="mb-0"><strong class="text-primary">STORE</strong> Opens 24 Hours</h1>
