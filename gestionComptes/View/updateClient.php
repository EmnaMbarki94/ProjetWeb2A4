...
<div class="site-navbar py-2">
    ...
    <div class="container">
        <div class="d-flex align-items-center justify-content-between">
            <div class="logo">
                <div class="site-logo">
                    <a href="listClients.php" class="js-logo-clone"><strong class="text-primary">SPT </strong>SANTé POUR TOUS</a>
                </div>
            </div>
...
<style>
    ...
    <form action="" method="POST">
        <table>
            ...
            <tr>
                <td><label for="rolee">Role :</label></td>
                <td>
                    <input type="text" id="rolee" name="rolee" value="<?php echo $client['rolee'] ?>" readonly />
                </td>
            </tr>
