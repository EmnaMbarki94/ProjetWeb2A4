...
if (isset($_SESSION['email']) ) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        // Traitement des données envoyées via le formulaire de mise à jour
        if (
            !empty($_POST['nom']) &&
            !empty($_POST["prenom"]) &&
            !empty($_POST["email"]) &&
        ...
        if ($updateResult) {
            // Redirection avec un message de succès si la mise à jour a réussi
            ...
            header("Location: editProfile.php?error=Erreur lors de la mise à jour du profil");
            exit;
        }
    }
 ?>
