...
<label for="id_cabinet">ADRESSE cabinet :</label>
        ...
        <span id="erreurCabinet" style="color: red"></span>

        <input type="submit" value="rechercher" name="search"style="background-color: #75b239; color: #fff;">
  </form>
  <?php if (isset($list)) { ?>
    <br>
    <!--<h1>Consultations correspondantes au cabinet sélectionné :</h1>-->
    <ul>
        <?php foreach ($list as $consultation) { ?>
            <li><?= $consultation['email_patient'] ?> - <?= $consultation['date_consultation'] ?> - <?= $consultation['heure_consultation'] ?></li>
        <?php } ?>
    </ul>
<?php } ?>
